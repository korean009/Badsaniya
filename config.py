...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/korean009/Badsaniya",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)  # Fill this variable if your upstream repository is private

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+TuPUUatUQS01NThl")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/a6hum8.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/oii22q.jpg"
)
PLAYLIST_IMG_URL = "https://files.catbox.moe/d204y4.jpg"
STATS_IMG_URL = "https://files.catbox.moe/1gyrae.jpg"
